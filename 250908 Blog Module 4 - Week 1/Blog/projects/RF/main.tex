...
\begin{center}
    \includegraphics[width=0.7\textwidth]{projects/RF/image/rd_vs_dt.png}
\end{center}

\section{Khởi nguồn: Decision Tree}
\label{subsec:rf-advanced-comparison}
...
\label{subsec:rf-advanced-tuning}
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{projects/RF/image/dt.png}
\end{center}
...
\begin{center}
    \includegraphics[width=0.7\textwidth]{projects/RF/image/randomforest_vs_dt.png}
\end{center}
...
\label{subsec:rf-advanced-features}
...
\label{subsec:rf-advanced-evaluation}
