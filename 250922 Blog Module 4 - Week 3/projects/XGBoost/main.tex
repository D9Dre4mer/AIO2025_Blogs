...
\begin{abstract}
    ...
    \label{sec:xgboost-gradient-boosting}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{projects/XGBoost/image/XGB_1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{projects/XGBoost/image/XGB_2.png}
    ...
    \label{sec:xgboost-construction}
    ...
    \item \textbf{Khởi tạo $F_0$}: $\displaystyle F_0(x)=\arg\min_{\theta} \sum_{i=1}^N l \left(y_i, \, \theta \right)$, chẳng hạn:
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{projects/XGBoost/image/XGB_4.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.7\linewidth]{projects/XGBoost/image/XGB_3.png}
