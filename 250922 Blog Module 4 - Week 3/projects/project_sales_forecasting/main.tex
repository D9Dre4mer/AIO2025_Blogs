\begin{center}
    \Large\textbf{Dự báo Doanh số với Explainable AI (XAI):\\
...
\begin{abstract}
    ...
    \label{sec:sales-implementation}
    \subsection{Tổng quan pipeline}
    \begin{figure}[H] % [H], [h], [t], [b] để điều khiển vị trí
        \centering
        \includegraphics[width=0.8\textwidth]{projects/project_sales_forecasting/image/pipeline.png}
    ...
    \begin{figure}[H] % [H], [h], [t], [b] để điều khiển vị trí
        \centering
        % \includegraphics[width=0.8\textwidth]{projects/project_sales_forecasting/image/placeholder.png}
