...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.74\linewidth]{projects/Skills for AIO2025/image/resarch.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{projects/Skills for AIO2025/image/chatgpt.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{projects/Skills for AIO2025/image/notebook.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{projects/Skills for AIO2025/image/item.png}
    \label{fig:enter-label}
\end{figure}
- Lệnh chèn ảnh:
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{projects/Skills for AIO2025/image/figure.png}
    \label{fig:enter-label}
\end{figure}
- Lệnh tạo bảng:
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{projects/Skills for AIO2025/image/tabular.png}
    \label{fig:enter-label}
\end{figure}
- Các công thức toán học sẽ được viết giữa hai dấu \$\:
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{projects/Skills for AIO2025/image/formula.png}
    \label{fig:enter-label}
\end{figure}
